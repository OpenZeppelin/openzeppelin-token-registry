...
describe('projectResearcherVouchedPackages', () => {
      ...
      [
        {
          ...
          vouchTotals: ethers.utils.bigNumberify(500)
        },
        {
          id: ethers.utils.bigNumberify(1),
          vouchTotals: { '0xabcd': ethers.utils.bigNumberify(2250) }
        },
        {
          id: ethers.utils.bigNumberify(2),
          vouchTotals: { '0xabcd': ethers.utils.bigNumberify(2200) }
        }
      ]
    )
  })
  ...
  it('should remove a user once the unvouch everything', () => {
    ...
    expect(projectResearcherVouchedPackages(events)).toEqual({
      packages: {
        '0': {
          vouchTotals: {}
        },
